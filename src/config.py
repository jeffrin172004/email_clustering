...
#"outlook_client_id": "your_outlook_client_id",  # Replace with Azure app Client ID
#"outlook_client_secret": "your_outlook_client_secret"  # Replace with Azure app Client Secret